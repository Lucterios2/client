...
describe('CustomComponents', () => {
  ...
  it('components with tabls', async () => {
    ...
    expect(wrapper.findAll('div > div.tabcontent').length).toBe(3)
    expect(wrapper.find('div > div.tabcontent:nth-of-type(1)').attributes('value')).toBe('tab__1')
    expect(
      wrapper.find('div > div.tabcontent:nth-of-type(1) > table > tr > td').element
        .childElementCount
    ).toBe(1)
    expect(
      wrapper.find('div > div.tabcontent:nth-of-type(1) > table > tr > td > div').attributes().value
    ).toBe('bbb')
    expect(wrapper.find('div > div.tabcontent:nth-of-type(2)').attributes('value')).toBe('tab__2')
    expect(
      wrapper.find('div > div.tabcontent:nth-of-type(2) > table > tr > td').element
        .childElementCount
    ).toBe(1)
    expect(
      wrapper.find('div > div.tabcontent:nth-of-type(2) > table > tr > td > div').attributes().value
    ).toBe('ccc')
    expect(wrapper.find('div > div.tabcontent:nth-of-type(3)').attributes('value')).toBe('tab__3')
    expect(
      wrapper.find('div > div.tabcontent:nth-of-type(3) > table > tr > td').element
        .childElementCount
    ).toBe(1)
    expect(
      wrapper.find('div > div.tabcontent:nth-of-type(3) > table > tr > td > div').attributes().value
    ).toBe('ddd')
  })
